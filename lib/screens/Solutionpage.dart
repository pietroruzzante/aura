...
class _SolutionpageState extends State<Solutionpage> {
  ...
  List<Solution> _getSolutions(List<dynamic> data) {
    ...
    if (needSleep(data[0], data[8])) {
      solutions.add(Solution('Sleeping', 'assets/sleeping.jpg', 'Set your bedtime and wake-up times, and get personalized tips to wake up feeling refreshed. Explore relaxing bedtime routines designed to help you unwind and sleep deeply. Take charge of your sleep routine and enjoy waking up ready to take on the day.',
